...
////// Emissive:
                ...
                return fixed4(finalColor,(floor((distance(_BulleCoin.rgb,i.posWorld.rgb)*_Largeur))*floor((distance(i.posWorld.rgb,_node_1476.rgb)*_Largeur2))*floor((distance(i.posWorld.rgb,_node_9132.rgb)*_node_7601))));
            }
            ENDCG
        }
    }
